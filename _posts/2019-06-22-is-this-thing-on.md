---
summary: "*tap* *tap* Seems like this is reaching you."
---
...
[Twitter]: https://twitter.com/pradyunsg/

## Acknowledgements

This blog is built using [Jekyll] and the theme is based off [Pixyll]. The
theme, is heavily restyled, to be more in line with how I wanted my blog to
look like. I ended up making changes to almost every element of the design,
though the layout and colours are solid in Pixyll.
